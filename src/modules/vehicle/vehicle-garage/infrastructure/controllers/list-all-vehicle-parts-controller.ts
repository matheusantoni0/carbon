...
import { ListAllGaragesCommand } from "#/modules/garage/domain/commands/list-all-garages-command";
import { Garage } from "#/modules/garage/domain/entities/garage";
import { onSuccess } from "#/modules/garage/infrastructure/controllers/listeners/list-all-garages-listeners";
